	...
	private void printJournalHeader(){
		...
		switch (this.art){
		 	case KONTAKT:
	        	...
	        	if (this.prop.getProperty("conflictAction").compareTo("overwrite") == 0) LOGGER.log(Level.forName("JOURNAL", 50), "\t�berschreiben");
	        	if (this.prop.getProperty("conflictAction").compareTo("fillin") == 0) LOGGER.log(Level.forName("JOURNAL", 50), "\tAuff�llen");
	        	if (this.prop.getProperty("conflictAction").compareTo("skip") == 0) LOGGER.log(Level.forName("JOURNAL", 50), "\t�berspringen");
...
/*		    Document doc = db.parse(is);
	...
	public void actionPerformed(ActionEvent e) {
        ...
        //Handle Contact properties button action.
        	...
        	ButtonGroup group = new ButtonGroup();
        	JRadioButton overwriteRadioButton = new JRadioButton("�berschreiben");
        ...
        //Handle Connect properties button action.
    		...
    		Object[] message = {"Kundennummer", kundennummerTextField, "Benutzername", benutzernameTextField, "Passwort", passwortTextField, "Sprache", spracheTextField, "Gesellschaft", gesellschaftTextField, "Packetgr��e", packageSizeTextField};
